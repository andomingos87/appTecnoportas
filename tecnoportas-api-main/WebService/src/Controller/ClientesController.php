...
class ClientesController extends AppController
{
    ...
    public function ver()
    {
        ...
        if (!empty($cliente_id)) {
            $res = $this->connection->newQuery()
                ->select(
                    'pessoas.id, pessoas.nome, pessoas.sobrenome, pessoas.tipo, pessoas.cnpj,
                    emails.email, telefones.ddd, telefones.numero,
                    enderecos.uf, enderecos.cidade, enderecos.logradouro, enderecos.numero as endNumero, enderecos.referencia, enderecos.pais,
                    serralheiro.nome as se_nome, serralheiro.sobrenome as se_sobrenome')
                ->from('serralheiro_clientes')
                ->join(
                    [
                        'table' => 'pessoas',
    ...
    public function excluir()
    {
        ...
        $this->apagaOrcs("cliente",$cliente_id);
