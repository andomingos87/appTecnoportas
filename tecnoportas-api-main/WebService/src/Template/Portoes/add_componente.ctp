            ...
            <div class="panel-body">
                <form id='formComponente' role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id='tbCod' class="form-control" type='text' name='componente[codigo]'/>
                    </div>
                    <div class="form-group">
                        <label for='tbNome'>Nome:</label>
                        <input id='tbNome' class="form-control" type='text' name='componente[nome]'/>
                    </div>
                    <div class="form-group">
                        <label for='taDesc'>Descrição:</label>
                        <textarea id='taDesc' rows="3" class="form-control" name='componente[descricao]'></textarea>
                    </div>
                    <div class="form-group slide-toggle">
                        <label for='cbPadrao'>Definir componente como padrão: </label>
                        <input id='cbPadrao' type="checkbox" onchange="changePadrao(this)" class="js-switch-blue" name='componente[is_padrao]' value='1'/>
                    </div>
                    <div id="fixaRodape" class="form-group slide-toggle invisivel">
                        <label for='cbRodape'>Fixar no rodapé: </label>
                        <input id='cbRodape' type="checkbox" class="js-switch-blue" name='componente[is_rodape]' value='1'/>
                    </div>
                    <div id="divCondicao" class="form-group invisivel">
                        <label for='tbAplic'>Fórmula de Aplicação:</label> <a href="#myModal" data-toggle="modal"><i class="fa fa-info-circle"></i></a>
                        <input id='tbAplic' type='text' class="form-control formula" name='componente[condicao]' data-submit="btSubmit"/>
                    ...
                    <div class="form-group">
                        ...
                        <input id='tbVu' type='text' class="form-control" name='componente[valor_unitario]' placeholder="0.00"/>
                    </div>
                    <div class="form-group">
                        <label for='tbCp'>Cálculo do Preço:</label> <a href="#myModal" data-toggle="modal"><i class="fa fa-info-circle"></i></a>
                        <input id='tbCp' type='text' class="form-control formula" name='componente[formula]' data-submit="btSubmit"/>
                        <p class="help-block error-feedback">Parece que á algo errado, <a href="#myModal" data-toggle="modal">clique aqui</a>.</p>
