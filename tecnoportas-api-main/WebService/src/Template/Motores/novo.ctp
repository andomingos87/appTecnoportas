            ...
            <div class="panel-body">
                <form id='formMotores' method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input id='tbCod' class="form-control" type='text' name='motor[codigo]'/>
                    </div>
                    <div class="form-group">
                        <label for='tbNome'>Nome:</label>
                        <input id='tbNome' type='text' class="form-control" name='motor[nome]'/>
                    </div>
                    <div class="form-group">
                        <label for='taDesc'>Descrição:</label>
                        <textarea id='taDesc' rows="3" class="form-control" name='motor[descricao]'></textarea>
                    </div>
                    <div class="form-group">
                        <label for='tbKg'>Fórmula: </label><a href="#myModal" data-toggle="modal"><i class="fa fa-info-circle"></i></a>
                        <input id='tbKg' class="form-control formula" type='text' name='motor[formula]' data-submit="btSubmit" required/>
                    ...
                    <div class="form-group">
                        ...
                        <input id='tbVu' class="form-control" type='text' name='motor[valor_unitario]' placeholder="0.00"/>
                    </div>
                    <div class="form-group">
                        <div>
