            ...
            <div class="panel-body">
                <form id='formAtributo' role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id='tbNome' class="form-control" type='text' name='atributo[nome]'/>
                    </div>
                    <div id="divLigs" class="form-group">
                        <div>
                        ...
                        <div id="divPrf" class="divLig">
                            ...
                            <label class="checkbox-inline">
                                ...
                                <input type="checkbox" value="<?= $pr['id'] ?>" name="ligacoes[]" id="ligacoes<?= $pr['id'] ?>">
                            </label>
                            <?php endforeach; else: ?>
                            <strong>Nenhuma ligação cadastrada!</strong>
                            <?php endif; ?>
                        </div>
                        <div id="divEsp" class="divLig invisivel">
                            <?php if (count($esp)) : foreach ($esp as $es) : ?>
                            <label class="checkbox-inline">
                                <label for="ligacoes<?= $es['id'] ?>">
                                    <div><?= $es['nome'] ?></div>
                                </label>
                                <input type="checkbox" value="<?= $es['id'] ?>" name="ligacoes[]" id="ligacoes<?= $es['id'] ?>">
                            </label>
                            <?php endforeach; else: ?>
                            <strong>Nenhuma ligação cadastrada!</strong>
                            <?php endif; ?>
                        </div>
                        <div id="divMat" class="divLig invisivel">
                            <?php if (count($mat)) : foreach ($mat as $ma) : ?>
                            <label class="checkbox-inline">
                                <label for="ligacoes<?= $ma['id'] ?>">
                                    <div><?= $ma['nome'] ?></div>
                                </label>
                                <input type="checkbox" value="<?= $ma['id'] ?>" name="ligacoes[]" id="ligacoes<?= $ma['id'] ?>">
                            </label>
                            <?php endforeach; else: ?>
                            <strong>Nenhuma ligação cadastrada!</strong>
                            <?php endif; ?>
                        </div>
                        <div id="divEntr" class="divLig invisivel">
                            ...
                            <label class="checkbox-inline">
                                ...
                                <input type="checkbox" value="<?= $po['id'] ?>" name="ligacoes[]" id="ligacoes<?= $po['id'] ?>">
                            </label>
                            <?php endforeach; else: ?>
                            <strong>Nenhuma ligação cadastrada!</strong>
                            <?php endif; ?>
